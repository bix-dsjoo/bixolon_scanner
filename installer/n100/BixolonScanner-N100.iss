#ifndef AppVersion
  #error AppVersion must be supplied by build_n100_installer.ps1
#endif
#ifndef PayloadDir
  #error PayloadDir must be supplied by build_n100_installer.ps1
#endif
#ifndef OutputDir
  #error OutputDir must be supplied by build_n100_installer.ps1
#endif
#ifndef SetupIconPath
  #error SetupIconPath must be supplied by build_n100_installer.ps1
#endif
#ifndef VcRedistPath
  #error VcRedistPath must be supplied by build_n100_installer.ps1
#endif

#define AppName "BIXOLON Scanner"
...
OutputDir={#OutputDir}
OutputBaseFilename=BixolonScanner-N100-{#AppVersion}-Setup
...
Filename: "{#PowerShellPath}"; Parameters: "-NoLogo -NoProfile -NonInteractive -ExecutionPolicy Bypass -WindowStyle Hidden -File ""{app}\start-bixolon-scanner.ps1"""; Description: "BIXOLON Scanner 실행"; Flags: postinstall nowait skipifsilent unchecked
