...
void main() {
  String sample(String name) =>
      File('../../docs/contracts/examples/0.1.8/$name.json').readAsStringSync();

  test('0.1.8 APPROVED sample parses', () {
    ...
    expect(response.modelVersions.worker, '0.1.8');
  });

  test('0.1.8 UNKNOWN sample parses with ordered Top-3', () {
  ...
  test('0.1.8 SEGMENT_RECAPTURE sample parses', () {
  ...
  test('0.1.8 IMAGE_RECAPTURE sample parses separately from ERROR', () {
