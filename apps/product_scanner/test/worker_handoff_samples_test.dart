...
void main() {
  String sample(String name) =>
      File('../../docs/contracts/examples/0.1.7/$name.json').readAsStringSync();

  test('0.1.7 APPROVED sample parses', () {
    ...
    expect(response.modelVersions.worker, '0.1.7');
  });

  test('0.1.7 UNKNOWN sample parses with ordered Top-3', () {
  ...
  test('0.1.7 SEGMENT_RECAPTURE sample parses', () {
  ...
  test('0.1.7 IMAGE_RECAPTURE sample parses separately from ERROR', () {
