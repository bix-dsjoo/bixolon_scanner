...
void main() {
  String sample(String name) =>
      File('../../docs/contracts/examples/0.1.14/$name.json').readAsStringSync();

  test('0.1.14 APPROVED sample parses', () {
    ...
    expect(response.modelVersions.worker, '0.1.14');
  });

  test('0.1.14 UNKNOWN sample parses with ordered Top-3', () {
  ...
  test('0.1.14 SEGMENT_RECAPTURE sample parses', () {
  ...
  test('0.1.14 IMAGE_RECAPTURE sample parses separately from ERROR', () {
