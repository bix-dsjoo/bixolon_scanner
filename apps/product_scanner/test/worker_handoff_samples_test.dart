...
void main() {
  String sample(String name) =>
      File('../../docs/contracts/examples/0.1.12/$name.json').readAsStringSync();

  test('0.1.12 APPROVED sample parses', () {
    ...
    expect(response.modelVersions.worker, '0.1.12');
  });

  test('0.1.12 UNKNOWN sample parses with ordered Top-3', () {
  ...
  test('0.1.12 SEGMENT_RECAPTURE sample parses', () {
  ...
  test('0.1.12 IMAGE_RECAPTURE sample parses separately from ERROR', () {
