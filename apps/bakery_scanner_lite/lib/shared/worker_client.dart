  ...
  Future<void> _start() async {
    ...
    _process = await Process.start(
      ...
      environment: {
        ...
        'BIXOLON_CPU_DETECTOR_INTRA_OP_THREADS': n100 ? '4' : '8',
        'BIXOLON_CPU_EMBEDDER_INTRA_OP_THREADS': n100 ? '4' : '12',
        'BIXOLON_OPENVINO_GPU_PRECISION': n100 ? 'f16' : 'f32',
        'BIXOLON_REUSE_VERIFIER_EMBEDDINGS': 'true',
        'BIXOLON_PARALLEL_VERIFICATION': '$n100',
        'BIXOLON_LOG_MODEL_TIMINGS': '$n100',
