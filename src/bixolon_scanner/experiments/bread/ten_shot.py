...
from ...training.small_data import build_frofa_training_set, fit_linear_svm_head
...
from ...training.ten_shot_candidates import (
    CandidateResult,
    challenger_required,
...
from ...training.ten_shot_training import (
    HeadTrainingConfig,
...
def _apply_approval_threshold_guard(
    ...
    *,
    ...
    if guard <= 0:
        return calibration
    from ...training.calibration import binomial_rate_upper_bound, softmax
...
def calibrate(args: argparse.Namespace, config: dict[str, Any]) -> None:
    ...
    from ...training.calibration import binomial_rate_upper_bound, softmax, topk_accuracy
