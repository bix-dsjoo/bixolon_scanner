...
def _development_metrics(decision: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "false_approval_rate_upper_95": metrics[
...
def _test_94_metrics(report: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "false_approval_rate_upper_95": classifier[
            "approved_false_rate_upper_95"
        ],
        "approval_coverage": classifier[
...
def _bread_project_2_metrics(report: dict[str, Any]) -> dict[str, Any]:
    ...
    conservative_top3_correct = approved_correct + int(
        overall["unknown_top3_correct"]
    )
    return {
...
def build_final_report(
    *,
    ...
    report = evaluate_promotion_gates(
        ...
        baseline={
            "approval_coverage": baseline_metadata["calibration"][
                "approval_coverage"
            ]
        },
        parity={
            "pytorch_cpu_pass": bool(
                parity_checks["pytorch_cpu_tolerance"] and exact_outputs
            ),
            "pytorch_cuda_pass": bool(
                parity_checks["pytorch_cuda_tolerance"] and exact_outputs
            ),
            "cross_provider_pass": bool(
                parity_checks["cpu_cuda_tolerance"] and exact_outputs
            ),
        },
        benchmark={
            "full_path_p95_ms": benchmark_report["by_path"]["full_path"]["p95_ms"]
        },
        detector={
        ...
        regression_sets={
            ...
            "bread_project_2_300": _bread_project_2_metrics(
                bread_project_2_report
            ),
        },
    ...
    report["evidence"] = {
        ...
        "classifier_onnx_sha256": benchmark_report["package_artifact_sha256"][
            "classifier.onnx"
        ],
