...
공개된 non-null 버전 값은 모두 같은 제품 버전이어야 합니다. `0.1.1` Worker에서는 실행된
구성요소의 버전도 모두 `0.1.1`입니다.
...
```json
{
  ...
  "classifier_version": "0.1.1",
  "embedder_version": "0.1.1",
  "detector_policy_version": "0.1.1",
  "classifier_policy_version": "0.1.1",
