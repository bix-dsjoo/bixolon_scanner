...
활성 문서는 현재 `0.1.12` 실행 조합과 변하지 않는 API·아키텍처 계약만 설명합니다. 과거 버전과
평가 판단은 [archive](archive/version-history.md)에 보존합니다.

- [현재 버전과 고정 해시](status/current.md)
- [아키텍처 개요](architecture/overview.md)
- [Scanner 0.1.12 번들 구조](architecture/scanner-0.1.12.md)
- [Worker API 계약](contracts/api.md)
- [Flutter 개발자용 Worker 연동 명세](contracts/worker-integration-0.1.12.md)
