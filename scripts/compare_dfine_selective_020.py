...
def main():
    ...
    candidate = work / "candidates/dfine-dense-selective"
    policy = {
    ...
    if not candidate.exists():
        ...
        metadata["quality"]["detector_segment_recapture_score_threshold"] = 0.25
        metadata["quality"]["skip_low_score_classification"] = True
    ...
    report = measure(
        ...
        work / "measurements/dfine-dense-selective",
