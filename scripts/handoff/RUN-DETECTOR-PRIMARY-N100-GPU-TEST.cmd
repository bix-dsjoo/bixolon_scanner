...
set "PACKAGE_DIR=%~dp0"
set "RESULT_PATH=%PACKAGE_DIR%n100-detector-primary-0.1.11-openvino-device-matrix.json"

echo BIXOLON detector-primary 0.1.11 candidate N100 CPU vs CPU+iGPU benchmark
