...
set "PACKAGE_DIR=%~dp0"
set "RESULT_PATH=%PACKAGE_DIR%n100-yolo-free-0.1.7-openvino-device-matrix.json"

echo BIXOLON YOLO-free 0.1.7 candidate N100 CPU vs CPU+iGPU benchmark
...
"%POWERSHELL%" -NoLogo -NoProfile -ExecutionPolicy Bypass ^
  ...
  -ExpectedCountComparisonMode "exact_count" ^
  -ExpectedCountConfidenceThreshold 0.0 ^
