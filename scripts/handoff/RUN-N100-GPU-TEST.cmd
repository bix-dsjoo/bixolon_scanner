...
set "PACKAGE_DIR=%~dp0"
set "RESULT_PATH=%PACKAGE_DIR%n100-0.1.14-openvino-device-matrix.json"

echo BIXOLON Bakery AI Scanner 0.1.14 N100 OpenVINO CPU-only vs CPU Detector + Intel GPU Embedder
