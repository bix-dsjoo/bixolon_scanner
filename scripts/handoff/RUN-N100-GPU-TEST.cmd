...
set "PACKAGE_DIR=%~dp0"
set "RESULT_PATH=%PACKAGE_DIR%n100-0.1.3-openvino-device-matrix.json"

echo BIXOLON Scanner 0.1.3 N100 OpenVINO CPU-only vs CPU Detector + Intel GPU Embedder
